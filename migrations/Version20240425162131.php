 ...
 */
final class Version20240425162131 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork_category ADD created_by_id INT NOT NULL, ADD updated_by_id INT DEFAULT NULL, DROP created_by, DROP updated_by');
