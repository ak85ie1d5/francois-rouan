 ...
 */
final class Version20240425140224 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork_category ADD created_by_id INT NOT NULL, ADD updated_by_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork_category DROP created_by_id, DROP updated_by_id');
    }
}
